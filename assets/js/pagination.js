    ...
    callback: function (data, pagination) {
      let paginationFoodPromise = new Promise(function (myResolve) {
        if(token == '' || token == null || token == undefined){
          token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkYWMiLCJyb2xlcyI6WyJST0xFX1VTRVIiXSwiaXNzIjoiaHR0cHM6Ly9oZmItdDEwOThlLmhlcm9rdWFwcC5jb20vYXBpL3YxL2hmYi9sb2dpbiIsImV4cCI6MTYzNjA4ODI4NH0.oPVqUCKQKWRyByh-NHBQ3mWXpSNg8QsTnzllmZ0rXB4';
        }
        var dataHtml = "<div>";
